    ...
    createPortal(
      <>
        ...
        {authStatus === "authenticated" ? (
          ...
          <div className="fixed z-20 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-5/6 w-7/12">
            <div className="bg-white rounded-lg px-12 pt-12 pb-4 h-full overflow-scroll flex flex-col justify-center items-center">
              <h1 className="font-large text-xl pb-8">In order to edit comments, please sign in!</h1>
              <button
                className="bg-purple rounded-lg h-12 w-40 text-white"
                onClick={() => signIn()}
              >
                Sign In
              </button>
